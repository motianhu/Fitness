...
public function __construct()
	...
	public function priv($id = '')
	{
		...
		$menu_list = $this->menu_model->get_all_menu(array('disabled'=>'false'));
		//菜单树		
	...
	public function save_priv($id = '')
	{
		...
		$auth = $this->admin_role_priv_model->get_role_priv((int)$id); //已有权限
		$result = $this->array_diff_assoc2_deep($insert_arr, $auth); //更改数据处理
	...
	{
		$this->admin_role_model->del ( array (
				'role_id' => $id 
		) );
