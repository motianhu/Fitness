...
class Area extends My_Controller
{
	...
	public function index($page = 1)
	{
		...
		$sql_arr['data_sql'] = "SELECT a.*,b.name AS pname FROM w_area a LEFT JOIN w_area b ON a.pid = b.id limit $page," . pageSize;
		$sql_arr['count_sql'] = "SELECT count(id) as cnt FROM w_area";
