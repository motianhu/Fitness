...
/*
	...
	this.reload = function(img_url){
		if(img_url!=null && img_url != ""){
			...
			$("#"+img_content_id).html("<img id='"+img_id+"' src='"+os+"' style='width:100%;height:auto;' />");
			$("#"+img_id).bind("load",
				function(){
					//check_thums_img();
					sel.init();
	...
	this.init = function(){
        ...
        //设置选择框默认位置
		api.animateTo([ 0, 0, select_width,select_height ]);

	}

	this.submit = function(){
		return {w:w,h:h,x:x,y:y,s:os,oh:oh,ow:ow};
	}
}