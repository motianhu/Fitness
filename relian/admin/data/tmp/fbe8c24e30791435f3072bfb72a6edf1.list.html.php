                                ...
                                <div class="btn-group">
                                    ...
                                    <a class="btn btn-small show-tooltip" title="Edit"
                                       href="<?php echo base_url() ; ?>sys/admin_role/detail/<?php echo $this->_vars->value['role_id'] ; ?>"><i
                                            class="icon-edit"></i></a>
                                    <a class="btn btn-small btn-danger show-tooltip" title="Delete" href="<?php echo base_url() ; ?>sys/admin_role/del/<?php echo $this->_vars->value['role_id'] ; ?>" onclick="return confirm('确认删除？');"><i class="icon-trash"></i></a>
                                </div>
                            </td>
                        </tr>
                        <?php } ?>
