	        ...
	        <div class="weui-tab">
		            <div class="weui-tab__panel">
						<div class="weui-tab_banner">
							<img alt="" src="<?php echo base_url();?>static/img/md<?php echo $id;?>_detail1.png">
						</div>
						<div style="padding:6px;margin-top:34px;">
							<div class="weui-tab_md_detail">
								<img alt="" src="<?php echo base_url();?>static/img/md<?php echo $id;?>_detail2.png">
							</div>
							<div class="weui-tab_md_detail">
								<img alt="" src="<?php echo base_url();?>static/img/md<?php echo $id;?>_detail3.png">
							</div>
							<div class="weui-tab_md_detail">
								<img alt="" src="<?php echo base_url();?>static/img/md<?php echo $id;?>_detail4.png">
							</div>
							<div class="weui-tab_md_detail">
								<img alt="" src="<?php echo base_url();?>static/img/md<?php echo $id;?>_detail5.png">
							</div>
						</div>
		            </div>
	                <div class="weui-tabbar">
						<a href="<?php echo base_url();?>index.php/Store" class="weui-tabbar__item weui-bar__item_on">
