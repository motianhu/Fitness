	        ...
	        <div class="weui-tab">
		            <div class="weui-tab__panel">
						<div class="weui-tab_banner">
							<img alt="" src="<?php echo base_url();?>static/img/kc<?php echo $id;?>_1.png">
						</div>
						<div style="padding:6px;margin-top:34px;">
							<div class="weui-tab_md_detail">
								<img alt="" src="<?php echo base_url();?>static/img/kc<?php echo $id;?>_2.png">
							</div>
							<div class="weui-tab_md_detail">
								<img alt="" src="<?php echo base_url();?>static/img/md1_detail5.png">
							</div>
						</div>
						<div class="page__bd page__bd_spacing">
						    <a href="tel:075584034980" class="weui-btn weui-btn_primary">立即预约</a>
						</div>
		            </div>
	                <div class="weui-tabbar">
						...
						<a href="<?php echo base_url();?>index.php/Course" class="weui-tabbar__item weui-bar__item_on">
